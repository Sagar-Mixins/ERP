      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center border-b border-white/10 px-3">
          ...
          <button
            ...
            className="hidden size-10 shrink-0 place-items-center rounded-xl text-slate-400 transition hover:bg-white/10 hover:text-white lg:grid"
          >
            {isExpanded ? (
          ...
          <button
            ...
            className="grid size-10 shrink-0 place-items-center rounded-xl text-slate-400 transition hover:bg-white/10 hover:text-white lg:hidden"
          >
            <LuX size={22} />
          </button>
        ...
        >
          ...
          <div className="space-y-1">
            ...
            {menuGroups.map((group) => {
              ...
              const isOpen =
                isExpanded &&
                (openGroup === group.label || hasActiveItem);
